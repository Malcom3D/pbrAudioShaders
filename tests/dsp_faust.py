...
# Static DSP (pre-compiled)
# faust_static = faust_module.DspFaust(44100, 256)

# Dynamic DSP (JIT compilation from file or string)
# faust_dynamic_file = faust_module.DspFaust("path/to/your/dsp/file.dsp", 44100, 256)
# faust_dynamic_string = faust_module.DspFaust("process = _;", 44100, 256)  # Example Faust code
