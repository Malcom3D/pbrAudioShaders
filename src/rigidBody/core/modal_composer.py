...
class ModalComposer:
    ...
    def compute(self, collision: Any) -> None:
        ...
        for force_type in range(1, 5):
            ...
            final_force1[type_mask1] = np.divide(force1[force_type][type_mask1], n_vertex_ids1[type_mask1], axis=1), out=np.zeros_like(force1[force_type][type_mask1]), where=n_vertex_ids1[type_mask1] != 0)
            ...
            if force_type in [2,3,4]:
                ...
                final_force1[mixed_mask1] = np.divide(force1[force_type][mixed_mask1], n_vertex_ids1[mixed_mask1], axis=1), out=np.zeros_like(force1[force_type][mixed_mask1]), where=n_vertex_ids1[mixed_mask1] != 0)
            ...
            final_force2[type_mask2] = np.divide(force2[force_type][type_mask2], n_vertex_ids2[type_mask2], axis=1), out=np.zeros_like(force2[force_type][type_mask2]), where=n_vertex_ids2[type_mask2] != 0)
            ...
            if force_type in [2,3,4]:
                ...
                final_force2[mixed_mask2] = np.divide(force2[force_type][mixed_mask2], n_vertex_ids2[mixed_mask2], axis=1), out=np.zeros_like(force2[force_type][mixed_mask2]), where=n_vertex_ids2[mixed_mask2] != 0)
