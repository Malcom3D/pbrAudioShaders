        ...
        for sample_idx in frames:
            ...
            for o_idx in voxel_objects.keys():
                ...
                if len(points) > 0 or len(voxel_ids) > 0:
                    ...
                    a, b, c = (0.5 * particles_sizes).T
                    particles_volume = (4.0 / 3.0) * np.pi * a * b * c
                    particles_mass = particles_volume * particles_density
                    forces = np.linalg.norm(particles_vel, axis=1) * particles_mass
